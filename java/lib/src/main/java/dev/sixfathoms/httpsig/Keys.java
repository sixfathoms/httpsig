...
public final class Keys {
     ...
     */
    public static dev.sixfathoms.httpsig.KeyPair keyPair(String keyId, java.security.KeyPair jcaKeyPair) {
        Objects.requireNonNull(keyId);
        Objects.requireNonNull(jcaKeyPair);
        return new dev.sixfathoms.httpsig.KeyPair(
     ...
     */
    public static dev.sixfathoms.httpsig.KeyPair keyPair(String keyId, PrivateKey privateKey, PublicKey publicKey) {
        Objects.requireNonNull(keyId);
     ...
     */
    public static dev.sixfathoms.httpsig.KeyPair hmacKeyPair(String keyId, byte[] secret) {
        HmacKey key = hmacSHA256Key(keyId, secret);
        return new dev.sixfathoms.httpsig.KeyPair(key, key);
    }

    /**
     * Create an HMAC-SHA384 KeyPair where the same secret backs both sides.
     */
    public static dev.sixfathoms.httpsig.KeyPair hmacSha384KeyPair(String keyId, byte[] secret) {
     ...
     */
    public static dev.sixfathoms.httpsig.KeyPair hmacSha512KeyPair(String keyId, byte[] secret) {
