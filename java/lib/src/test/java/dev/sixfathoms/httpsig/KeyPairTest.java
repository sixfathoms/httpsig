...
class KeyPairTest {
    ...
    void rsaKeyPairRoundTrip() throws Exception {
        ...
        dev.sixfathoms.httpsig.KeyPair kp = Keys.keyPair("rsa-kp", priv, pub);
    ...
    void ecdsaKeyPairRoundTrip() throws Exception {
        ...
        dev.sixfathoms.httpsig.KeyPair kp = Keys.keyPair("ec-kp", priv, pub);
    ...
    void ed25519KeyPairRoundTrip() throws Exception {
        ...
        dev.sixfathoms.httpsig.KeyPair kp = Keys.keyPair("ed-kp", priv, pub);
    ...
    void hmacKeyPairRoundTrip() throws Exception {
        ...
        dev.sixfathoms.httpsig.KeyPair kp = Keys.hmacKeyPair("hmac-kp", secret);
    ...
    void jcaKeyPairBridge() throws Exception {
        ...
        dev.sixfathoms.httpsig.KeyPair kp = Keys.keyPair("jca-ed", jcaKp);
    ...
    void keyPairRejectsIdMismatch() throws Exception {
        ...
        assertThrows(IllegalArgumentException.class, () -> new dev.sixfathoms.httpsig.KeyPair(sk, vk));
    }
    ...
    void keyPairRejectsNullSigningKey() {
        assertThrows(NullPointerException.class, () ->
            new dev.sixfathoms.httpsig.KeyPair(null, Keys.ed25519VerifyingKey("x",
